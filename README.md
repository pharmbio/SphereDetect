...
# SphereDetect
High-content experiments imaging spheroids often generate excess image data. Such experiments would benefit from systematic an targeted data aquisition. It can be challenging to systematically find the positition where to start imaging, a position that may vary when basing the detection method on fluophore intensity and perturbations affect that intensity. There are several methods to perform on-the-fly detection but most are proprietary and microscope-specific. 
